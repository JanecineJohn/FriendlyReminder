 ...
 */
public class ToMeNewsAdapter extends RecyclerView.Adapter<ToMeNewsAdapter.ViewHolder>{

    List<News> newsList;
    Context mContext;

    /**构造函数*/
    public ToMeNewsAdapter(List<News> newsList){
...
//        holder.noticeTime.setText(news.getNoticeTime()+"");
        holder.noticeTime.setText("点击将设置一个" + noticeHour + "时" + noticeMin + "分的闹钟");
        holder.noticeContent.setText(news.getFromUserName() + "：" + news.getNoticeContent());
